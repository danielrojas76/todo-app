...
function App() {
  ...
  return (
    <div className='min-h-screen flex flex-col items-center justify-center gap-4 p-4 bg-custom-background bg-cover bg-center'>
      <div className='bg-gray-100 p-6 rounded shadiw-md w-full max-w-lg lg:w-1/4'>
        <h1 className='text-3xl font-bold text-center mb-4'>Todo App</h1>
        <div className='flex'>
          <input
            type="text"
            placeholder='Add a todo'
            className='py-2 px-4 border rounded w-full focus:autline-none mr-2'
            value={input}
